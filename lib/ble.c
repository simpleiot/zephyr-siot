...
static const RTC_RODATA_ATTR struct bt_uuid_128 vnd_uuid = BT_UUID_INIT_128(
	BT_UUID_CUSTOM_SERVICE_VAL);

static const RTC_RODATA_ATTR struct bt_uuid_128 vnd_enc_uuid = BT_UUID_INIT_128(
	BT_UUID_128_ENCODE(0x12345678, 0x1234, 0x5678, 0x1234, 0x56789abcdef1));

static const RTC_RODATA_ATTR struct bt_uuid_128 vnd_auth_uuid = BT_UUID_INIT_128(
...
static const RTC_RODATA_ATTR uint8_t vnd_value_init[VND_MAX_LEN + 1] = { 'V', 'e', 'n', 'd', 'o', 'r'};
static uint8_t vnd_value[VND_MAX_LEN + 1];

static const RTC_RODATA_ATTR uint8_t vnd_auth_value_init[VND_MAX_LEN + 1] = { 'V', 'e', 'n', 'd', 'o', 'r'};
static uint8_t vnd_auth_value[VND_MAX_LEN + 1];

static const RTC_RODATA_ATTR uint8_t vnd_wwr_value_init[VND_MAX_LEN + 1] = { 'V', 'e', 'n', 'd', 'o', 'r' };
static uint8_t vnd_wwr_value[VND_MAX_LEN + 1];
...
static const RTC_RODATA_ATTR uint8_t vnd_long_value_init[VND_LONG_MAX_LEN + 1] = {
...
static const RTC_RODATA_ATTR struct bt_uuid_128 vnd_long_uuid = BT_UUID_INIT_128(
	BT_UUID_128_ENCODE(0x12345678, 0x1234, 0x5678, 0x1234, 0x56789abcdef3));

static const RTC_RODATA_ATTR struct bt_gatt_cep vnd_long_cep = {
...
static const RTC_RODATA_ATTR struct bt_uuid_128 vnd_signed_uuid = BT_UUID_INIT_128(
	BT_UUID_128_ENCODE(0x13345678, 0x1234, 0x5678, 0x1334, 0x56789abcdef3));

static const RTC_RODATA_ATTR struct bt_uuid_128 vnd_write_cmd_uuid = BT_UUID_INIT_128(
...
static const RTC_RODATA_ATTR struct bt_data ad[] = {
...
static const RTC_RODATA_ATTR struct bt_data sd[] = {
...
// Add initialization function to copy const data to RAM
static void init_vendor_values(void)
{
	memcpy(vnd_value, vnd_value_init, sizeof(vnd_value));
	memcpy(vnd_auth_value, vnd_auth_value_init, sizeof(vnd_auth_value));
	memcpy(vnd_wwr_value, vnd_wwr_value_init, sizeof(vnd_wwr_value));
	memcpy(vnd_long_value, vnd_long_value_init, sizeof(vnd_long_value));
}
